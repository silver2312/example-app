@extends('layouts.app')
@section('title', 'Quản lý tag truyện')
@section('content')
...
<div class="col-12 mt-2">
    <a href="#!" class="btn btn-primary" style="margin-left:20px;margin-bottom:20px;" data-toggle="modal" data-target="#them_tag">Thêm tag mới</a>
    {{-- Thêm chung_toc --}}
    <div class="modal fade" id="them_tag" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype='multipart/form-data' method="POST" action="{{url('mod/tag/them')}}" autocomplete="off">
                    @csrf
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="sua_{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Sửa tag: {{$value->ten}}</h5>
                                    </div>
                                    <div class="modal-body">
                                        <form enctype='multipart/form-data' method="POST" action="{{url('mod/tag/sua/'.$value->id)}}" autocomplete="off">
                                            @csrf
                                            <div class="form-group">
                                                <label>Tên</label>
