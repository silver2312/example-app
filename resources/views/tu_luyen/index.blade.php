                                            ...
                                            @if(isset($data_thongtin[0]))
                                                ...
                                                <div id="canh_gioi">
                                                    ...
                                                    @if($data_nhanvat[0]['nghenghiep_id'] != null)
                                                        ...
                                                        ?>
                                                        <a href="#!" data-toggle="modal" data-target="#nghe_nghiep_exp"  rel="tooltip" data-placement="bottom" data-html="true" title="{{ format_num($data_nhanvat[0]['exp_nghenghiep_hientai']).'/'.format_num($data_nhanvat[0]['exp_nghenghiep_max']) }}">{{$nghe_nghiep->ten}} • <span class="{{$chitiet_nghenghiep->css}} ">{{$chitiet_nghenghiep->ten}}</span></a><br>
                                                        @if(isset($uid))
